...
<div class="page-header text-center"
    ...
    <div class="container">
        <h1 class="page-title">Terms and Conditions<span></span></h1>
    </div><!-- End .container -->
</div><!-- End .page-header -->
...
<div class="page-content">
    ...
    <div class="container">
        <div class="heading">
            ...
            <p class="title-desc">Last updated: June 13, 2025</p>
        </div>
        ...
        <ul>
            ...
            <li>
                <strong>Website</strong> refers to Phoenix, accessible from <a href="https://phoeni.store"
                    rel="external nofollow noopener" target="_blank">https://phoeni.store</a>
            </li>
            <li>
        ...
        <div class="heading">
            <h2 class="title">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
        </div>
        ...
        <div class="heading">
            <h2 class="title">Disputes Resolution</h2>
        </div>
        ...
        <div class="heading">
            <h2 class="title">For European Union (EU) Users</h2>
        </div>
        ...
        <div class="heading">
            <h2 class="title">United States Legal Compliance</h2>
        </div>
        ...
        <div class="heading">
            <h2 class="title">Severability and Waiver</h2>
        </div>
        <h3>Severability</h3>
        ...
        <div class="heading">
            <h2 class="title">Translation Interpretation</h2>
        </div>
        ...
        <div class="heading">
            <h2 class="title">Changes to These Terms</h2>
        </div>
        ...
        <ul>
            <li>By WhatsApp: +91 91000 38900</li>
        </ul>
    </div>
