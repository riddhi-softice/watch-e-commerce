                        ...
                        <div class="row">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery">
                                <a class="product-gallery-item active" href="#"
                                    ...
                                    data-zoom-image="{{ asset('public/assets/images/products/single/1-big.jpg') }}">
                                    <img src="{{ asset('public/assets/images/products/single/1-small.jpg') }}"
                                        alt="product side">
                                </a>
                                ...
                                <a class="product-gallery-item" href="#"
                                    ...
                                    <img src="{{ asset('public/assets/images/products/single/2-small.jpg') }}"
                                        alt="product cross">
                                </a>
                                ...
                                <a class="product-gallery-item" href="#"
                                    ...
                                    <img src="{{ asset('public/assets/images/products/single/3-small.jpg') }}"
                                ...
                                <a class="product-gallery-item" href="#"
                                    ...
                                    <img src="{{ asset('public/assets/images/products/single/4-small.jpg') }}"
                                        alt="product back">
                                </a>
        ...
        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
            ...
            <div class="product product-7 text-center">
                ...
                <div class="product-body">
                    ...
                    <div class="product-nav product-nav-thumbs">
                        <a href="#" class="active">
                            <img src="{{ asset('public/assets/images/products/product-4-thumb.jpg') }}"
                                alt="product desc">
                        </a>
                        <a href="#">
                            <img src="{{ asset('public/assets/images/products/product-4-2-thumb.jpg') }}"
                                alt="product desc">
                        </a>
                        <a href="#">
                            <img src="{{ asset('public/assets/images/products/product-4-3-thumb.jpg') }}"
                                alt="product desc">
                        </a>
                    </div><!-- End .product-nav -->
